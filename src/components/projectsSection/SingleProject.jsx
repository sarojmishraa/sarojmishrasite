...
const SingleProject = ({ name, year, align, image, link, description }) => {
  return (
    ...
    >
      ...
      <div className="max-h-[360px] min-w-[360px]  max-w-[600px] rounded-xl overflow-hidden hover:scale-110 transform transition-all duration-500 relative border border-white">
